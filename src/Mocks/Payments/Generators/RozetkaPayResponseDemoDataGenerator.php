...
class RozetkaPayResponseDemoDataGenerator
{
    ...
    public static function generatePaymentInfo(array $data = []): PaymentInfo
    {
        ...
        return PaymentInfo::fromArray(array_merge([
            ...
            'confirmed' => true,
            'confirmation_details' => PaymentDetailsList::fromArray([$confirmationDetails->toArray()]),
            'canceled' => false,
            'cancellation_details' => PaymentDetailsList::fromArray([$cancelDetails->toArray()]),
            'refunded' => false,
            'refund_details' => PaymentDetailsList::fromArray([$refundDetails->toArray()]),
